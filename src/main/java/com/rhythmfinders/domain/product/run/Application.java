...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            switch(input){
                 ...
                 *  */
                case 2: ps.findProductBy(chooseMemNo()); break;
                case 3: ps.registProduct(signUp()); break;
                case 4: ps.removeProduct(chooseMemNo()); break;
                case 5: ps.modifyProduct(chooseMemNo(), modifyUp()); break;
                case 9:
    ...
    private static Product signUp() {
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));        System.out.print("아이디를 입력하세요: ");
